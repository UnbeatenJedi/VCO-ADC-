...
setenv PATH ${PATH}:${CADHOME}/GENUS152/tools/bin
...
setenv PATH ${PATH}:${CADHOME}/INNOVUS152/bin
...
#
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
setenv PATH ${PATH}:$CADHOME/INCISIVE151/bin:${CADHOME}/INCISIVE151/tools/bin:${CADHOME}/INCISIVE151/tools/vtools/vfault/bin
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
setenv uvm_home ${CADHOME}/INCISIVE151/tools/uvm
setenv ml_uvm ${CADHOME}/INCISIVE151/tools/uvm/uvm_lib/uvm_ml/sc/ml_uvm
setenv ml_seq_dir ${CADHOME}/INCISIVE151/specman/src

#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Set up the HOME Environment Variable for Incisive Verification Kits
# Source the appropriate environment setup file
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#setenv SOCV_KIT_HOME ${CADHOME}/INCISIVE151/kits/VerificationKit
...
# virtuoso &
setenv AMSHOME
/usr/local/cadence/IUS81ISR_Inx86
set path=($path/usr/local/cadence/IU81ISR_Inx86/tools/bin)
set path=($path/usr/local/cadence/IU81ISR_Inx86/tools/dfill/bin)
set path=($path/usr/local/cadence/IU81ISR_Inx86/tools/simvision/bin)
